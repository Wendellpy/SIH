...
const DropdownMenu = ({ options, children, align = "left" }: DropdownMenuProps) => {
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className={`absolute z-10 w-48 mt-2 p-1 bg-[#11111198] rounded-xl shadow-[0_0_20px_rgba(0,0,0,0.2)] backdrop-blur-sm flex flex-col gap-2 ${align === "right" ? "right-0" : "left-0"}`}
          >
